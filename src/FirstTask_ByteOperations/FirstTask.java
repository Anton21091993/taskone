...
public class FirstTask {
    public static void main(String[] args) {
      ...
      Integer Reference2= 15;
        ...
        System.out.println(Result2.toBinaryString(Result2)); //1010

        Integer Result3 = Reference1 &= Reference2;
        System.out.println(Result3.toBinaryString(Result3)); //1010


        Integer Result4 = Reference1 | Reference2;
        System.out.println(Result4.toBinaryString(Result4)); //1111

        Integer Result5 = Reference1 |= Reference2;
        System.out.println(Result5.toBinaryString(Result5)); //1111
